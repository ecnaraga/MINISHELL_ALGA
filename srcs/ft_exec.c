...
/*   Updated: 2023/12/03 13:48:28 by garance          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_create_sub_msh(t_msh *sub_msh, t_msh *msh, t_split **head)
{
	pid_t	pid;
	
	sub_msh->line = ft_magic_malloc(ADD, 0, ft_strtrim_msh(msh->line, "()"), NO_ENV);
